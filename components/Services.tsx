...
const Services: React.FC = () => {
  ...
  return (
    <section id="servizi" className="py-24 bg-pattern-dots relative" ref={sectionRef}>
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SERVICES_DATA.map((service) => (
            <div
              key={service.id}
              className="service-card group bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-soft hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 flex flex-col items-start opacity-0"
            >
