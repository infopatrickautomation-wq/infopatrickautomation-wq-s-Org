  ...
  return (
    <header
      className={`w-full z-50 transition-all duration-300 ${isScrolled
        ? 'fixed top-0 bg-[#1C1F26]/90 backdrop-blur-md shadow-lg py-2'
      ...
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center space-x-6">
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
              className={`text-sm font-bold uppercase tracking-wider transition-colors cursor-pointer ${isScrolled ? 'text-gray-300 hover:text-white' : 'text-white hover:text-orange-500'
                }`}
            >
              {link.name}
            </a>
        ...
        <div className="hidden lg:flex items-center gap-4">
          <a
            ...
            className={`flex items-center gap-2 text-sm font-bold hover:text-orange-500 transition-colors ${isScrolled ? 'text-white' : 'text-white'
              }`}
          >
