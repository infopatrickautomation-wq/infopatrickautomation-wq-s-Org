...
const StatCounter: React.FC<{ end: number, label: string, suffix?: string }> = ({ end, label, suffix = "" }) => {
  ...
  return (
    <div ref={elementRef} className="text-center p-6 bg-white rounded-3xl shadow-lg border border-gray-100 flex flex-col justify-center">
      <span className="text-4xl md:text-5xl font-black text-blue-900 mb-2 font-heading">
        {count}{suffix}
      </span>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        <div className="lg:w-1/2">
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-8 -right-8 bg-orange-600 text-white p-10 rounded-[40px] z-20 hidden md:block shadow-2xl">
        ...
        <div className="lg:w-1/2">
          <h2 className="text-orange-600 font-bold tracking-widest uppercase text-sm mb-3">La nostra storia</h2>
          <h3 className="text-4xl md:text-5xl font-bold font-heading text-blue-900 mb-8 leading-tight">Passione e professionalità dal 1998</h3>
          ...
          <div className="space-y-6 text-gray-600 text-lg leading-relaxed font-light">
            ...
            <p className="font-medium text-blue-900 italic border-l-4 border-orange-500 pl-6">
